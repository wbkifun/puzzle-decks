...
parts.append(f'<text x="{dx+dw+130}" y="{dy+dh*0.54}" font-family="{FONT}" font-size="22" fill="{INK}">아무리 당겨도</text>')
parts.append(f'<text x="{dx+dw+130}" y="{dy+dh*0.54+30}" font-family="{FONT}" font-size="22" fill="{INK}">꿈쩍도 안 한다</text>')
...
parts.append(f'<text x="{dx+dw+128}" y="{dy+dh*0.40}" font-family="{FONT}" font-size="23" font-weight="700" fill="{INK}">밀면 열린다</text>')
