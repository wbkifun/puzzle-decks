...
parts, xe = term_chain(85, [("x", {}), ("2x", {}), ("2x+6", G), Q, Q], ["×2", "+6", "÷2", "−처음 수"])
...
# ---------- 변형 2 문제 ----------
parts, xe = term_chain(85, [("x", {}), ("3x", G), ("3x+12", G), Q, Q], ["×3", "+12", "÷3", "−처음 수"])
...
parts, xe = term_chain(85, [("x", {}), ("3x", G), ("3x+10", {}), Q, Q], ["×3", "+10", "÷2", "−처음 수"])
