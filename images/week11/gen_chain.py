...
# ================= 추가 응용 3건 · 도전 2건 =================
assert 20 * 15 == 200 + 100                                  # 기차 길이 100m
assert 2 * 23 + 4 * (35 - 23) == 94                          # 닭 23, 토끼 12
assert abs(1.3 * 20000 - 2000 - 1.2 * 20000) < 1e-9          # 원가 20,000원
assert 20 + 20 * 2 == 30 + 15 * 2 == 60                      # 에스컬레이터 60계단
assert 6 * 7 - 3 == 5 * 7 + 4 == 39                          # 책상 7줄, 학생 39명

scale_chain("s_train_chain_a.svg", [("20×15=200+x", {}), ("300=200+x", G), ("x=100", RG)],
            ["계산", "양변 −200"])
scale_chain("s_hen_chain_a.svg", [("2x+4(35−x)=94", {}), ("140−2x=94", G), ("2x=46", G), ("x=23", RG)],
            ["괄호 풀고 정리", "양변 +2x, −94", "양변 ÷2"])
scale_chain("s_price_chain_a.svg", [("1.3x−2000=1.2x", {}), ("0.1x−2000=0", G), ("0.1x=2000", G), ("x=20000", RG)],
            ["양변 −1.2x", "양변 +2000", "양변 ×10"])
scale_chain("sc2_chain_a.svg", [("20+20x=30+15x", {}), ("5x=10", G), ("x=2", RG)],
            ["양변 −15x, −20", "양변 ÷5"])
scale_chain("sc3_chain_a.svg", [("6x−3=5x+4", {}), ("x−3=4", G), ("x=7", RG)],
            ["양변 −5x", "양변 +3"])
